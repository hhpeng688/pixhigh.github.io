...
pages: index.html smartportrait/index.html dracula/index.html privacy/index.html terms/index.html
...
<body>
  <div class="container">
    ...
    <section class="card">
      <h2>Quick Help</h2>
      <ul class="list">
        <li>For missing filters, refresh the preset list and check your purchase status.</li>
        <li>For export quality, select the highest resolution available in the app.</li>
        <li>For crash reports, include the last action you took before the crash.</li>
      </ul>
    </section>
    ...
    <section>
      <h2>Contact</h2>
      <p>Email <a href="mailto:$(EMAIL)">$(EMAIL)</a> with your device model and a screenshot if possible.</p>
    </section>
